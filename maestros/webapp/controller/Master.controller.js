sap.ui.define([
	...
	return BaseController.extend("com.tasa.maestros.controller.Master", {
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("NAMEAPP", FilterOperator.Contains, sQuery)];
			} else {
		...
		onLiveChange:function(oEvent){
			...
			if (sQuery && sQuery.length > 0) {
				var filter = new Filter("NAMEAPP", FilterOperator.Contains, sQuery);
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.tasa.maestros.view.ViewSettingsDialog",
					controller: this
