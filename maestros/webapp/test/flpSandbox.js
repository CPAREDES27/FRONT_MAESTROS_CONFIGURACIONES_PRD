					...
					"config": {
						"inbounds": {
							"Maestros-display": {
								...
								"action": "display",
								"description": "Aplicación de maestros",
								"title": "Maestros",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.maestros",
									"url": sap.ui.require.toUrl("com/tasa/maestros")
								}
							}
						}
					}
