						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Configuraciones-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"Configuraciones-display": {
								...
								"action": "display",
								"description": "Aplicación de configuraciones",
								"title": "Configuraciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.config",
									"url": sap.ui.require.toUrl("com/tasa/config")
								}
							}
						}
					}
