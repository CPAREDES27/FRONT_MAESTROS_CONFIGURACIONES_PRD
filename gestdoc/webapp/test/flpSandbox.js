		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comtasagestdoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtasagestdoc-display": {
								"semanticObject": "comtasagestdoc",
								"action": "display",
								"description": "renderiza iFrame",
								"title": "Gestión Documentaria",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.gestdoc",
									"url": sap.ui.require.toUrl("com/tasa/gestdoc")
								}
							}
						}
					}
